...
<Navbar class="bg-{background_color} fixed w-full z-20 top-0 start-0">
	...
	<div class="flex md:order-2">
		<button class="px-10 py-3 text-2xl font-black uppercase text-white bg-{background_color} hidden md:flex neumorphism">Contact</button>
...
<Footer footerType="logo" class="bg-[#c4c4c4] rounded-none">
	<div class="sm:flex sm:items-center sm:justify-between">
		<FooterBrand href="/" src="" alt="Nathaniel Rand Logo" name="Nathaniel Rand" />
	</div>
